...
// $config['smtp_host'] = 'No';             // SMTP Server Address.
...
$config['mailtype'] = 'text';               // text or html	Type of mail. If you send HTML email you must
                                            // send it as a complete web page. Make sure you don't have any relative
